...
Gold Medalist Engineer (MNIT Jaipur, 9.62 CGPA) building **scalable, production-grade systems**.

Full-stack developer specializing in **Java (Spring Boot), Python, and MERN**, designing **high-performance APIs (REST/GraphQL)** and systems that hold under real-world load.

Strong in **DSA, OOPs, DBMS, and System Design** — focused on **depth, performance, and clean architecture**, not shortcuts.

Currently building at the intersection of **AI, automation (MCP), and developer tooling** to create **intelligent, high-impact systems**.
